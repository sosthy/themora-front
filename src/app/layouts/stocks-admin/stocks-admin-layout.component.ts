...
@Component({
  selector: 'app-layout-stocks',
  templateUrl: './stocks-admin-layout.component.html',
  styleUrls: ['./stocks-admin-layout.component.scss']
})
export class StocksAdminLayoutComponent implements OnInit, OnDestroy, AfterViewInit {
